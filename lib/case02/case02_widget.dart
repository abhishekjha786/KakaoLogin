...
class Case02Widget extends StatefulWidget {
  const Case02Widget({Key? key}) : super(key: key);

  @override
  _Case02WidgetState createState() => _Case02WidgetState();
}

class _Case02WidgetState extends State<Case02Widget> {
