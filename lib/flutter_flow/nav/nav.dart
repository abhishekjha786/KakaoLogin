...
class AppStateNotifier extends ChangeNotifier {
  DetectiveFirebaseUser? initialUser;
  DetectiveFirebaseUser? user;
  ...
  void update(DetectiveFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomePageWidget() : OnbodingWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'user_requestAdd02',
              path: 'userRequestAdd02',
            ...
            FFRoute(
              name: 'Case02',
              path: 'case02',
              builder: (context, params) => Case02Widget(),
            ),
            FFRoute(
              name: 'Case01_detail',
              path: 'case01Detail',
